...
insert into events(name, description, min_size, max_size) values("MYSTERY ROOM", "Mystery Room is a non tech event based on the quintessential Escape Room! Be it invisible ink or confusing riddles, deciphering the clues is the only way out!", 1, 2 );
