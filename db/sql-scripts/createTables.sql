CREATE TABLE `users` ( `id` INT(11) NOT NULL PRIMARY key auto_increment, `qr` VARCHAR(255) NOT NULL UNIQUE, `name` VARCHAR(255) NOT NULL, `email` VARCHAR(255) NOT NULL UNIQUE, `mobile` VARCHAR(255) NOT NULL, `password` VARCHAR(255) NOT NULL, `token` VARCHAR(255) DEFAULT NULL, `access` INT(11) NOT NULL DEFAULT 1);
...
CREATE TABLE `results` (`team` INT(11) NOT NULL, `event` INT(11) NOT NULL, `score` INT(11) NOT NULL, `round` INT(11) NOT NULL, primary key(`team`, `event`));
