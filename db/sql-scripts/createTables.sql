CREATE TABLE `users` ( `id` INT(11) NOT NULL PRIMARY key auto_increment, `qr` VARCHAR(255) NOT NULL UNIQUE, `name` VARCHAR(255) NOT NULL, `email` VARCHAR(255) NOT NULL UNIQUE, `mobile` VARCHAR(255) NOT NULL, `password` VARCHAR(255) NOT NULL, `token` VARCHAR(255) DEFAULT NULL, `active` INT(11) DEFAULT 0, `access` INT(11) DEFAULT 1);
CREATE TABLE `events` ( `id` INT(11) NOT NULL PRIMARY key auto_increment, `name` VARCHAR(255) NOT NULL, `description` text NOT NULL, `min_size` INT(11) NOT NULL, `max_size` INT(11) NOT NULL, `online` INT(11) NOT NULL DEFAULT 0, `link` VARCHAR(255));
