...
loader.load("fonts/helvetiker_regular.typeface.json", function(font) {
  ...
  var userNameMaterials = [
    new THREE.MeshPhongMaterial({ color: 0xffffff, flatShading: THREE.FlatShading }), // front
    new THREE.MeshPhongMaterial({ color: 0x550055, flatShading: THREE.FlatShading }) // side
  ];
